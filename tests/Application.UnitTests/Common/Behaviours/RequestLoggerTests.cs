using EchoPost.Application.Posts;
using EchoPost.Application.Common.Behaviours;
...
namespace EchoPost.Application.UnitTests.Common.Behaviours;
...
public class RequestLoggerTests
{
    ...
    public async Task ShouldCallGetUserNameAsyncOnceIfAuthenticated()
    {
        ...
        await requestLogger.Process(new CreatePostCommand { Content = "jasndjansjdnajklsndjaksdjlkalskdkaskldklasdnaskldnklasndklnaskldnaklsdnk", Title = "title" }, new CancellationToken());
